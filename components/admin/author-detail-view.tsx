    ...
    return (
      <div className="space-y-6">
        ...
        <EmptyState
          ...
          description="Supabase ortam değişkenlerini ayarladıktan sonra persona detayı burada görünecek."
          action={
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 rounded-lg border border-border bg-muted/40 px-4 py-3 text-sm text-muted-foreground">
        ...
        <p>
          Bu kayıt gerçek bir kişi değildir. BYTOK AI editoryal personasıdır;
          haber üretiminde kullanılan kurgusal bir yazım sesidir.
        </p>
      </div>
      ...
      <section className="rounded-lg border border-border bg-card/40 px-4">
        <dl>
          ...
          <DetailRow label="Uzmanlık alanları">
            {author.expertise.length > 0 ? author.expertise.join(", ") : "—"}
          </DetailRow>
      ...
      <section className="space-y-3">
        ...
        {recentArticles.length === 0 ? (
          <EmptyState
            ...
            description="Bu personasına bağlı haber bulunmuyor."
          />
        ) : (
